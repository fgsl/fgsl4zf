 ...
 * 
 * This plugin depends on existence of a model called RouteRuler that has following public methods:
 * bool hasRouteStartup()
 * bool hasRouteShutdown()
 * bool hasRoutePreDispatch()
 * bool hasRoutePosDispatch()
 * array getRouteStartup()
 * array getRouteShutdown()
 * array getRoutePreDispatch()
 * array getRoutePosDispatch()
...
class Fgsl_Plugin_Controller extends Zend_Controller_Plugin_Abstract
{
	...
	{
    	$this->_routeRuler = new RouteRuler();
